	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$(this).fancybox({
			...
			'titleFormat': function() {
 				return '<a href="'
 				+ $(element).attr('show_url')
 				+'" target="_blank" class="fancybox-link"><div class="fancybox-link-container">'
 				+ $(element).attr('title')
 				+ '<img src="_layout/images/link.png" height="28" width="28" style="position: relative; top: 7px; margin-left: 8px;"/></div></a>';
				 }
			});
		});
